...
public class ProcFactory {
    ...
    public static Map<ProtoMsg.HeadType, ServerReciever> factory  = new HashMap<ProtoMsg.HeadType, ServerReciever>();
    ...
    private ProcFactory()
    {
        try
        {
            ...
            ServerReciever proc = new LoginProcesses();
            factory.put(proc.op(), proc);

            proc = new ChatRedirectProcesses();
            factory.put(proc.op(), proc);
